...
if (isset($_POST['saveInvoice'])) {
   ...
   if ($m_penarikan == "tunai") {
      $query = "INSERT INTO transaksi (transaksi_id, user_id, m_penarikan, t_barang, t_harga, t_harga_beli, is_paid) VALUES ('$id_transaksi', '$id_user', '$m_penarikan', '$t_barang', '$t_harga', '$t_harga_beli', '$is_paid')";
      ...
      $query_invoice = "INSERT INTO transaksi (transaksi_id, user_id, m_penarikan, t_barang, t_harga, t_harga_beli, is_paid) VALUES ('$id_transaksi', '$id_user', '$m_penarikan', '$t_barang', '$t_harga', '$t_harga_beli', '$is_paid')";
